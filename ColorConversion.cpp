...
AcrylicEverywhere::Rgb::Rgb(double r, double g, double b) : r{ r }, g{ g }, b{ b }
{
}

AcrylicEverywhere::Hsv::Hsv(double h, double s, double v) : h{ h }, s{ s }, v{ v }
{
}

std::optional<unsigned long> AcrylicEverywhere::TryParseInt(const std::wstring_view& s)
{
    return TryParseInt(s, 10 /* base */);
}

std::optional<unsigned long> AcrylicEverywhere::TryParseInt(const std::wstring_view& str, int base)
{
...
AcrylicEverywhere::Hsv AcrylicEverywhere::RgbToHsv(const Rgb& rgb)
{
    double hue = 0;
    double saturation = 0;
    double value = 0;
...
AcrylicEverywhere::Rgb AcrylicEverywhere::HsvToRgb(const AcrylicEverywhere::Hsv& hsv)
{
    double hue = hsv.h;
    ...
    if (chroma == 0)
    {
        return AcrylicEverywhere::Rgb(min, min, min);
    }
    ...
    return AcrylicEverywhere::Rgb(r, g, b);
}

AcrylicEverywhere::Rgb AcrylicEverywhere::HexToRgb(const std::wstring_view& input)
{
    const auto [rgb, a] = HexToRgba(input);
    return rgb;
}

winrt::hstring AcrylicEverywhere::RgbToHex(const Rgb& rgb)
{
...
std::tuple<AcrylicEverywhere::Rgb, double> AcrylicEverywhere::HexToRgba(const std::wstring_view& input)
{
...
winrt::hstring AcrylicEverywhere::RgbaToHex(const AcrylicEverywhere::Rgb& rgb, double alpha)
{
...
winrt::Windows::UI::Color AcrylicEverywhere::ColorFromRgba(const AcrylicEverywhere::Rgb& rgb, double alpha)
{
...
AcrylicEverywhere::Rgb AcrylicEverywhere::RgbFromColor(const winrt::Windows::UI::Color& color)
{

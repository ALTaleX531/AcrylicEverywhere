...
namespace AcrylicEverywhere::HookHelper::Detours
{
...
bool HookHelper::IsBadReadPtr(const void* ptr)
{
	bool result{ false };
...
PVOID HookHelper::WritePointer(PVOID* memoryAddress, PVOID value) try
{
...
{
	THROW_HR_IF(E_INVALIDARG, IsBadReadPtr(baseAddress));
